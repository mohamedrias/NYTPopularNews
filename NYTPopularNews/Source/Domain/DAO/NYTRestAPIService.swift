...
public class NYTRestAPIService: NYTDomain {
    ...
    private static let API_TOKEN: String = "865a9fb03c424e9c92c7098718ca07c5"
    private static let BASE_URL: String = "https://api.nytimes.com/svc/mostpopular/v2"
    ...
    private static func getUrl(section: String = "all-sections", duration: String = "7") -> String {
        return BASE_URL + "/mostviewed/"+section+"/"+duration+".json?api-key="+API_TOKEN
    }
